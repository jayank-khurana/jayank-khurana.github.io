...
import { ReachWidgetProps, ReachWidget } from "./reach-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/reach-widget.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <reach-widget message="world!"></reach-widget>
   */
  return class ReachWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): ReachWidgetProps {
      const attrs = this.parseAttributes<ReachWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<ReachWidget {...this.props} />);
    }
